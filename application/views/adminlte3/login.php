...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    <div class="login-logo">
      <div>
        <img src="<?php print base_url('adminlte3/'); ?>dist/img/undip1.png" style="z-index: 0;" class="img-circle elevation-2" alt="User Image">
      </div>
      <font color="white"><b>Statistik</b> Desa</font>
    </div>
    <!-- /.login-logo -->
    <div class="card">
