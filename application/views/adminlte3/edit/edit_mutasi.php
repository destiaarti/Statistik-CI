            ...
            <section class="content">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <form class="form-horizontal" action="<?php echo site_url(). '/admin/kependudukan/update_mutasi'; ?>" role="form" method="post"> 
                    <div class="row">
                    

             		 <input type="text" class="form-control" name="id_mutasi" placeholder="ID Desa" value="<?php echo $data->id_mutasi ?>" readonly hidden>
                      ...
                      <input type="text" class="form-control" name="jenis_mutasi" placeholder="ID Desa" value="<?php echo $data->jenis_mutasi ?>" readonly>
					 <br>
                       <a class="navbar-brand" href="#pablo" style="color: #1d1124"><b>Jenis Kelamin</b></a>
                            <input type="text" class="form-control" name="jenis_kelamin" placeholder="ID Desa" value="<?php echo $data->jenis_kelamin ?>" readonly>
                      <br>
                    </div> 
                    <div class="col-lg-6 col-md-6 col-sm-6">
                     ...
                     <a class="btn btn-danger" href="<?php echo base_url() ?>admin/kependudukan/">Batal</a>
                   </form>
                 <?php endforeach ?>
               </section>
             </div>
