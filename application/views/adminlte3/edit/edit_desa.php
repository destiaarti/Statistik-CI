              ...
              foreach ($tb_pembagian_desa as $data)
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <form class="form-horizontal" action="<?php echo site_url(). '/admin/desa/update_desa'; ?>" role="form" method="post"> 
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6">

                          <input type="text" class="form-control" name="id_pembagian_desa" placeholder="ID Desa" value="<?php echo $data->id_pembagian_desa ?>" hidden>
                       <br>
                       ...
                       <?php $id_desa = $data->id_desa;
					  	...
					  	$c = $get3->nama_desa;?>
						  <input type="text" class="form-control" name="id_desa" placeholder="Nama Desa" value="<?php echo $c ?>" readonly>
                       <br>
                       ...
                       <input type="text" class="form-control" name="dusun" placeholder="Jumlah Dusun" value="<?php echo $data->dusun ?>" required>
                       <br>
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-6">
                       ...
                       <a class="btn btn-danger" href="<?php echo base_url() ?>admin/desa">Batal</a>
                     </form>
                   <?php endforeach ?>
                 </section>
               </div>
