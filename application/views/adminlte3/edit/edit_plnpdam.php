              ...
              foreach ($tb_pln_pdam as $data)
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <form class="form-horizontal" action="<?php echo site_url(). '/admin/pln_pdam/update_plnpdam'; ?>" role="form" method="post"> 
                    <div class="row">
                  ...
                  <?php $id_desa = $data->id_desa;
                    ...
                    <a class="navbar-brand" href="#pablo" style="color: #1d1124"><b>Tahun</b></a>
                       ...
                       <a class="btn btn-danger" href="<?php echo base_url() ?>admin/pln_pdam">Batal</a>
                     </form>
                   <?php endforeach ?>
                 </section>
               </div>
