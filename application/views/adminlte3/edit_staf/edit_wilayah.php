...
<body class="">
              ...
              foreach ($tb_luas_wilayah as $data)
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <form class="form-horizontal" action="<?php echo site_url(). '/staf/wilayah/update_wilayah'; ?>" role="form" method="post"> 
                    <div class="row">
 ...
 <?php $id_desa = $data->id_desa;
					  ...
					  <input type="text" class="form-control" name="id_desa" placeholder="ID Desa" value="<?php echo $c ?>" readonly>
                       ...
                       <input type="text" class="form-control" name="tanah_sawah" placeholder="ID Desa" value="<?php echo $data->tanah_sawah ?>" required>
                       <br>

                     </div> 
                     <div class="col-lg-6 col-md-6 col-sm-6">
                       <a class="navbar-brand" href="#pablo" style="color: #1d1124"><b>Tanah Kering</b></a>
                       <input type="text" class="form-control" name="tanah_kering" placeholder="ID Desa" value="<?php echo $data->tanah_kering ?>" required>
                       <br>
                       ...
                       <a class="btn btn-danger" href="<?php echo base_url() ?>staf/wilayah">Batal</a>
                     </form>
                   <?php endforeach ?>
                 </section>
               </div>
