              ...
              foreach ($tb_panen_produksi as $data)
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <form class="form-horizontal" action="<?php echo site_url(). '/staf/pertanian/update_pertanian'; ?>" role="form" method="post"> 
                    <div class="row">
     ...
     <input type="text" class="form-control" name="id_panen" placeholder="ID Desa" value="<?php echo $data->id_panen ?>" readonly hidden>
                  ...
                  <?php $id_desa = $data->id_desa;
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-6">
                       ...
                       <a class="btn btn-danger" href="<?php echo base_url() ?>staf/pertanian/">Batal</a>
                     </form>
                   <?php endforeach ?>
                 </section>
               </div>
