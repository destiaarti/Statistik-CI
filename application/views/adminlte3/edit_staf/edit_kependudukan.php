              ...
              foreach ($tb_kependudukan as $data)
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <form class="form-horizontal" action="<?php echo site_url(). '/staf/penduduk/update_kependudukan'; ?>" role="form" method="post"> 
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6">

                      
                       <input type="text" class="form-control" name="id_kependudukan" placeholder="ID Desa" value="<?php echo $data->id_kependudukan ?>" readonly hidden>
                       <br>
                      ...
                      <a class="navbar-brand" href="#pablo" style="color: #1d1124"><b>Tahun</b></a>
                       <input type="text" class="form-control" name="tahun" placeholder="Tahun" value="<?php echo $data->tahun ?>" readonly>
                       <br>
