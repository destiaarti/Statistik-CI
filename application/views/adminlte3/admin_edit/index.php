        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-info">
              ...
              <form class="form-horizontal" action="<?php echo base_url('superadmin/admin/edit')?>" method="post" enctype="multipart/form-data" role="form">
                ...
                <div class="modal-footer">
                  ...
                  <a class="btn btn-danger" href="<?php echo base_url() ?>superadmin/admin">Batal</a>
                </div>
              </form>
            </div>
          </div>
