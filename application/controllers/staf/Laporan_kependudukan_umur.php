<?php
Class Laporan_kependudukan_umur extends CI_Controller{
    ...
    public function index(){
        ...
        $pdf->ln(1);
        $pdf->SetFont('Arial','B',12);
        $pdf->Cell(18,0.7,"Laporan Pengelolaan Kependudukan berdasarkan Umur",0,10,'C');
        ...
        $dataWilayah = $this->db->get('tb_kependudukan_umur')->result();
